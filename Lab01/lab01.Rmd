...
```{r}
sd(subset(data_sub, series_name == "Sherlock")$UserRating)

sd(subset(data_sub, series_name == "13 Reasons Why")$UserRating)

sd(subset(data_sub, series_name == "How to Get Away with Murder")$UserRating)
```
